...
const FAQSection: React.FC = () => {
  ...
  const faqItems: FAQItem[] = [
    {
      ...
      answer: "A platform connecting real estate investors, agents, and deal finders to streamline sourcing, submitting, and reviewing property deals.",
    },
    {
...

    {
      ...
      answer: "Fill out the property questionnaire on the home page and click 'Save' or 'Update'. Your deal will be added to your dashboard.",
    },
    {
  ...
  return (
    <section className="mt-20 bg-[#050505] border border-neutral-700 rounded-lg p-8 shadow-md hover:shadow-lg transition text-white">
      <h2 className="text-3xl md:text-4xl font-bold text-accent2 text-center mb-8">
        ...
        {faqItems.map((item, index) => (
          ...
          >
            <button
              ...
              className="w-full text-left px-4 py-4 flex justify-between items-center hover:bg-[#6e5690] hover:text-black transition"
            >
